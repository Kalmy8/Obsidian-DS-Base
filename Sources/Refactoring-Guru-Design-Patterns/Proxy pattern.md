...
?
[](Proxy.mhtml)
The **Proxy pattern** is a [Structural patterns](Structural%20patterns.md) used to wrap some base object with a **proxy object**, which will disguise itself as an original object. **Proxy object usually fully manages the wrappee object lifecycle**, and is used to add some caching, logging, access restrictions, initialization, and, possibly, any additional logic that should happen before or after calling the original object (just like the [Decorator pattern](Decorator%20pattern.md) does).
##### Proxy structure
[](Pasted%20image%2020240903090807.png)
