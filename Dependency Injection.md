...
- You can pass some different implementations using dependency injection (like in a [Strategy pattern](Strategy%20pattern.md)), rather then hardcoding one pre-defined implementation.
